...
public class Car implements Comparable<Car>{
    ...
    public void setRealArriveTime(int realArriveTime) {
...
//				+ ", priority=" + priority + ", preset=" + preset + ", carStatus=" + carStatus + ", indexWay="
//				+ indexWay + ", depCar=" + depCar + "]";
//	}
	
//	@Override
//	public String toString() {
//		return "Car [id=" + id + ", from=" + from + ", to=" + to + ", speed=" + speed + ", plantime=" + plantime
//				+ ", priority=" + priority + ", preset=" + preset + ", indexWay="
//				+ indexWay + "]";
//	}
...
//    }
    ...
    public String toString() {
    	// TODO Auto-generated method stub
    	return "\n" + this.carStatus.getDirection() + "-" + this.id + "-" + this.carStatus.getNowSpeed() + "-" + this.getPriority() + "-" + this.getPreset() + "-" + this.carStatus.getLocation();
    }
